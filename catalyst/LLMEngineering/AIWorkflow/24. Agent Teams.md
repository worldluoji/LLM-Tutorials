...
## 开启 Agent Teams
Agent Teams 在 Claude Code 中仍属于实验特性（Experimental）。开关名 `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS` 沿用至 2026；后续官方若改为稳定特性，开关名可能调整，请以 `/doctor` 输出与官方 release notes 为准。
