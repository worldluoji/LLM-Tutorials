...
- 第三，学会利用工具。在学习过程中，遇到不懂的知识点，你可以多和 ChatGPT 讨论。
  > **2025-2026 更新**：ChatGPT（GPT-4o / GPT-5 系列）已原生支持图像生成与图像理解，可以直接帮你读懂 SD 架构图、Diffusers 代码片段与论文截图；对于 Transformer、CLIP、DiT、扩散模型原理等基础知识讲解也比早期更准确，是学习 AI 绘画的高效伙伴。
